...
//           animate={isHovered ? { color: "#0F67B1" } : { color: "#1e40af" }}
//           transition={{ duration: 0.3 }}
//         >
//           {product.name}
//         </motion.h3>
...
//           initial={{ backgroundColor: "#37AFE1" }} // bg-blue-500
...
interface Product {
  ...
  new: boolean;
  image: string;
  pack?: string; // Added 'pack' as an optional property
...
const FeaturedProducts = () => {
  ...
  const handleAddToCart = (product: Product) => {
    ...
    // Show notification - FIXED: setting the visibility to true
    setNotification({
      message: `${product.name} ajouté au panier`,
      visible: true,
    });
    ...
    //   setNotification({
    //     message: "",
    //     visible: false, // FIXED: Properly setting visibility to false
    //   });
    // }, 3000);
  };
