...
// const Footer = () => {
//   return (
//     <footer className="mt-6 sm:mt-8 md:mt-10 mb-8 sm:mb-12 md:mb-16 px-0 ">
//       {/* Main Footer */}
//       <div className="mx-auto py-6 sm:py-8 md:py-10 lg:py-14 rounded-3xl  bg-white shadow-md sm:shadow-lg md:shadow-xl">
