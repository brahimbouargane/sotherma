...
const ContactForm: React.FC<ContactFormProps> = ({ className, onSubmit }) => {
  ...
  return (
    ...
    >
      ...
      {/* Form Container */}
      <motion.div
        className="bg-white z-10 relative max-w-4xl mx-auto  rounded-3xl shadow-lg p-8 md:px-12 md:py-4"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
      >
        <h2 className="text-3xl md:text-5xl text-blue-700 text-center font-normal mb-2">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-center">
            <motion.button
              type="submit"
              className="bg-blue-400 hover:bg-blue-500 text-white py-2 px-8 rounded-full transition-colors duration-300"
